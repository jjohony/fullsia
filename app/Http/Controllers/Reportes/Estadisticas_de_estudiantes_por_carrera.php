...
class Estadisticas_de_estudiantes_por_carrera extends PDF
{
    ...
    public function Header() {
        ...
        $this->Cell(140, 6, utf8_decode(""), 0, 0, 'L'); 
        ...
        $this->RoundedRect($this->GetX(),$this->GetY(), $w, $h,30, 'FD');

        //$this->CellFitSpace($w,$h, utf8_decode(""),0, 0 , 'C',false);

        $this->Line($x+30,$this->GetY(),$x+30,$this->GetY()+30);

        $this->Cell(10,10, utf8_decode($this->GetY()),0, 0 , 'C');
        $this->Ln(70);*/
    ...
    {   
        ...
        {   
            ...
            $cont++;
                ...
                $boolean=true;
                $this->Cell(45+80+64, 5, utf8_decode($value->carrera), 1, 1, 'C');
