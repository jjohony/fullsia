...
class Estudiantes_por_carrera extends \FPDF
{
    ...
    public function Header() {
        ...
        $this->Cell(185, 6, utf8_decode("NÓMINA DE ESTUDIANTES"), 0, 1, 'C'); 
        ...
        $this->Cell(70, 6, utf8_decode("APELLIDOS Y NOMBRES"), 1, 0, 'C');
        $this->Cell(25, 6, utf8_decode("SEMESTRE"), 1, 0, 'C');
        $this->Cell(25, 6, utf8_decode("SEXO"), 1, 0, 'C');
        $this->Cell(20, 6, utf8_decode("C.I."), 1, 0, 'C');
        $this->Cell(20, 6, utf8_decode("FEC. NAC."), 1, 0, 'C');
        $this->Cell(20, 6, utf8_decode("EDAD"), 1, 1, 'C');
    }
    ...
    {   
        ...
        {   
            ...
            $this->Cell(70, 6, utf8_decode($value->paterno." ".$value->materno." ".$value->nombre), 1, 0, 'L');
            $this->Cell(25, 6, utf8_decode(Funciones::numero_cardinal($value->nivel_asignatura)), 1, 0, 'C');
            $this->Cell(25, 6, utf8_decode($value->sexo), 1, 0, 'C');
            $this->Cell(20, 6, utf8_decode($value->numero_documento." ".$value->expedido), 1, 0, 'C');
            $this->Cell(20, 6, utf8_decode(date("d-m-Y",strtotime($value->fecha_nacimiento))), 1, 0, 'C');
            $this->Cell(20, 6, utf8_decode(date("Y")-date("Y",strtotime($value->fecha_nacimiento))), 1, 1, 'C');                   
