...
class Lista_de_estudiantes extends \FPDF
{
    ...
    {   
        ...
        $this->Ln(8);
        $this->Cell(0,0,'LISTA DE ESTUDIANTES',0,0,'C');
    ...
    {     
        ...
        switch ($curso->modalidad_asignatura) {
            case 'semestral':
                $modalidad="SEMESTRAL";
    ...
    {     
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(183,6,utf8_decode('APELLIDOS Y NOMBRES'),1,1,'C');        
    ...
    public function reporte($curso,$notas)
    {   
        ...
        if(!empty($notas))
        {
            ...
            { 
                ...
                $this->Cell(183,5,utf8_decode(strtoupper($value->paterno." ".$value->materno." ".$value->nombre)),1,1,'L');
        ...
        $this->Cell(9,5,'xxx',1,0,'C');            
        $this->Cell(183,5,'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',1,1,'C');
