...
class Asistencia_de_docente extends \FPDF
{
    ...
    public function reporte($docente,$fecha_inicio,$fecha_fin)
    {   
        ...
        $this->Cell(185, 6, utf8_decode('CONTROL DE ASISTENCIA DE DOCENTES'), 0, 1, 'C'); 
        $this->SetFont('Arial', '', 10);

        
        $fecha_inicio=($fecha_inicio!="")?date("d/m/Y",strtotime($fecha_inicio)):"";
        $fecha_fin=($fecha_fin!="")?date("d/m/Y",strtotime($fecha_fin)):"";
        
        $this->Cell(185, 6, utf8_decode("De ".$fecha_inicio." A ".$fecha_fin), 0, 1, 'C'); 
        ...
        {   
            ...
            foreach ($docente as $key => $value) {
                ...
                if($numero_documento!=$value->numero_documento)
                {
                    ...
                    $this->Cell(20, 6, utf8_decode("Nro. "), 0, 0, 'C');
                    $this->Cell(60, 6, utf8_decode("FECHA"), 0, 0, 'C');
                    $this->Cell(60, 6, utf8_decode("HORA"), 0, 0, 'C');
                    $this->Cell(60, 6, utf8_decode("ESTADO"), 0, 1, 'C');
                ...
                $this->Cell(20, 6, utf8_decode($cont), 0, 0, 'C');
                $this->AjustaCelda(60, 6, utf8_decode($value->fecha), 0, 0, 'C');
                $this->AjustaCelda(60, 6, utf8_decode($value->hora.":".$value->minuto.":".$value->segundo), 0, 0, 'C');
                $this->Cell(60, 6, utf8_decode($value->estado), 0, 1, 'C');
