...
class Boleta_inscripcion extends PDF
{
    ...
    {   
        ...
        $this->Cell(185, 6, utf8_decode("DATOS GENERALES DE LA INSCRIPCIÓN"), 0, 1, 'C'); 
        $this->SetFont('Arial', '', 8);
        $this->Cell(60, 6, utf8_decode("Datos Académicos"), 0, 1, 'L'); 
        
        $this->SetFont('Arial', '', 8);
        
        
        $this->Cell(60, 6, utf8_decode("Estudiante:: "), 0, 0, 'R'); 
        $this->Cell(65, 6, utf8_decode($this->estudiante->paterno." ".$this->estudiante->materno." ".$this->estudiante->nombre), 0, 0, 'L'); 
        $this->Cell(25, 6, utf8_decode("Gestión:: "), 0, 0, 'R'); 
        $this->Cell(33, 6, utf8_decode($this->estudiante->periodo_gestion." ".$this->estudiante->gestion), 0, 1, 'L'); 

        $this->Cell(60, 6, utf8_decode("Carrera:: "), 0, 0, 'R'); 
        $this->Cell(65, 6, utf8_decode($this->estudiante->carrera), 0, 0, 'L'); 
        $this->Cell(25, 6, utf8_decode("Plan:: "), 0, 0, 'R'); 
        $this->Cell(33, 6, utf8_decode($this->estudiante->plan_pensum), 0, 1, 'L'); 


        $mencion=($this->estudiante->mencion!="REGULAR")?"":$this->estudiante->mencion;
        $this->Cell(60, 6, utf8_decode("Mensión:: "), 0, 0, 'R'); 
        $this->Cell(65, 6, utf8_decode($mencion), 0, 0, 'L'); 
        $this->Cell(25, 6, utf8_decode("Fecha:: "), 0, 0, 'R'); 
        $this->Cell(33, 6, utf8_decode(date("d-m-Y",strtotime($this->estudiante->fecha))), 0, 1, 'L'); 
        $this->Cell(60, 6, utf8_decode("Código:: "), 0, 0, 'R'); 
        $this->Cell(65, 6, utf8_decode($usuario->name), 0, 0, 'L'); 
        /*$this->Cell(25, 6, utf8_decode("Tipo de Ingreso:: "), 0, 0, 'R'); 
        $this->Cell(33, 6, utf8_decode(""), 0, 1, 'L'); 

        $this->Ln(5);

        $this->MultiCell(60, 3, utf8_decode("Documentos presentados en registros y admisiones")); 

        $this->Cell(60, 6, utf8_decode("Fotocopia de TB:: "), 0, 0, 'R'); 
        $this->Cell(60, 6, utf8_decode(""), 0, 0, 'C'); 
        $this->Cell(30, 6, utf8_decode("Certificado de Nac.:: "), 0, 0, 'R'); 
        $this->Cell(33, 6, utf8_decode(""), 0, 1, 'L'); 

        $this->Cell(60, 6, utf8_decode("Fotocopia de C.I.:: "), 0, 0, 'R'); 
        $this->Cell(60, 6, utf8_decode(""), 0, 1, 'C'); 
        
        $this->MultiCell(185, 3, utf8_decode("Observaciones:: "));         */
