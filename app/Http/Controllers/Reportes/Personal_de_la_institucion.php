...
class Personal_de_la_institucion extends \FPDF
{
    ...
    {   
        $this->Image('../public/img/'.$this->configuracion->logo_reporte_imagen, 20, 2, 25, 25);
        ...
        $this->Cell(331, 5, utf8_decode('PERSONAL DE LA INSTITUCION'), 0, 1, 'C'); 

        $this->SetFont('Arial', '', 9);
        $this->Cell(331, 3, utf8_decode('Reporte de Datos Generales'), 0, 1, 'C'); 
        $this->Cell(331, 3, utf8_decode(date('d-m-Y')), 0, 1, 'C'); 

        $this->SetFont('Arial', '', 10);
        $this->Cell(331, 6, utf8_decode('LISTA DEL PERSONAL ACTIVO'), 0, 1, 'C'); 
        $this->Ln(2);
        
        $this->SetWidths(array( 10, 60, 20, 20, 18,15,15, 20, 15, 30, 15, 15,15, 15, 15, 15, 10));
        $this->SetHeights(array( 13, 13, 13, 13, null, 13,13, null, 13, 13, null,null, 13, 13, 13, null,null));
          $this->SetTamanio_font(array( 11, 11, 11,11, 8, 8, 8, 8,11, 11, 8, 8, 11,11, 11, 8, 8));
        ...
        $filas_dato = array(
            ...
            utf8_decode("C.I."),
            utf8_decode("Cargo"),
            utf8_decode("Unidad / Area"),
            utf8_decode("Telefono"),
            utf8_decode("Celular"),
            
            utf8_decode("Tipo de contrato"),
            utf8_decode("Turno"),
            utf8_decode("NIT"),
            utf8_decode("Nro Seguro"),
            utf8_decode("Nro. Cuenta"),
            utf8_decode("Banco"),
            utf8_decode("F. Nac."),
            utf8_decode("Edad"),
            utf8_decode("Fecha Ingreso"),
            utf8_decode("Fecha Retiro"),
    ...
    {   
        ...
        if(!empty($administrativo)){
            ...
            foreach ($administrativo as $key => $value) {
                ...
                $this->AjustaCelda(60,7,utf8_decode($value->paterno." ".$value->materno." ".$value->nombre),1,0,'L');
                $this->AjustaCelda(20,7,utf8_decode($value->numero_documento." ".$value->expedido),1,0,'C');
                $this->AjustaCelda(20,7,utf8_decode($value->cargo),1,0,'C');
                $this->AjustaCelda(18,7,utf8_decode($value->unidad_area),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->telefono),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->celular),1,0,'C');
                $this->AjustaCelda(20,7,utf8_decode($value->tipo_contrato),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->turno),1,0,'C');
                $this->AjustaCelda(30,7,utf8_decode($value->nit),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->numero_seguro_salud),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->numero_cuenta_bancaria),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->banco),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->fecha_nacimiento),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->fecha_nacimiento),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode($value->fecha_ingreso),1,0,'C');
                $this->AjustaCelda(10,7,utf8_decode($value->fecha_retiro),1,1,'C');
            }
            //}
        }
        ...
        else
        {
            for($i=1;$i<=(20-$num);$i++)
            {
                ...
                $this->AjustaCelda(60,7,utf8_decode(""),1,0,'L');
                $this->AjustaCelda(20,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(20,7,utf8_decode(""),1,0,'C');
                ...
                $this->AjustaCelda(20,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(30,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(15,7,utf8_decode(""),1,0,'C');
                $this->AjustaCelda(10,7,utf8_decode(""),1,1,'C');
