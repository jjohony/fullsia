...
class Historial_de_usuario extends \FPDF
{
    ...
    public function Header() {
        ...
        $this->Ln(8);
        $this->Cell(0,0,'REPORTE HISTORIAL DE USUARIO',0,0,'C');
       ...
       ini_set("session.auto_start", 0);
        ...
        $this->AjustaCelda(30,6,utf8_decode('USUARIO'),1,0,'C');        
        $this->AjustaCelda(30,6,utf8_decode('ROL DE USUARIO'),1,0,'C');        
        $this->AjustaCelda(30,6,utf8_decode('APELLIDOS Y NOMBRES'),1,0,'C');        
        $this->AjustaCelda(85,6,utf8_decode('CONSULTA'),1,0,'C');        
        $this->AjustaCelda(85,6,utf8_decode('DATOS'),1,0,'C'); 
        $this->AjustaCelda(20,6,utf8_decode('FECHA'),1,1,'C');        
    ...
    {   
        ...
        if(!empty($administrativo))
        {
            ...
            { 
                ...
                $this->SetWidths(array( 9, 30, 30, 30, 85,85,20));
                ...
                $filas_dato = array(
                    ...
                    utf8_decode(strtoupper($value->nombre_grupo)),            
                    utf8_decode(strtoupper($value->paterno." ".$value->materno." ".$value->nombre)),
                    utf8_decode($value->consulta),            
                    utf8_decode($value->datos),
                    utf8_decode(date("d-m-Y H:i:s",strtotime($value->fecha))),
                );
                
                

                $this->Row($filas_dato, 5, 4); 
        ...
        if(!empty($docente))
        {
            ...
            { 
                ...
                $filas_dato = array(
                    ...
                    utf8_decode($value->consulta),            
                    utf8_decode($value->datos),
                    utf8_decode(date("d-m-Y",strtotime($value->fecha))),
                );
