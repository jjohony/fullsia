...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/reporte/reporte_historial_de_usuario" method="get" accept-charset="utf-8" id="formulario" target="_blank">
                
                  <h2 class="text-center">Reporte de Historial de usuario</h2>
                  <!-- begin col-2 -->                                
