...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <h2 class="text-center">Reporte de Asistencia de Docentes</h2>       
            <form action="{{url('')}}/reporte/reporte_asistencia_de_docente" method="get" accept-charset="utf-8" id="formulario" target="blank">
                
                
                <!-- begin col-2 -->                                
                  <div class="form-group col-md-6">
                      <label class="col-md-12">Docente:</label>
                      <div class="col-md-12">                        
                        <select class="form-control chosen-select" data-rel="chosen" data-placeholder="docente" name="id_docente" >
                          <option value="">Todos</option>}
                          option
                          @if(!empty($docente))
                          @foreach($docente as $key=>$value)
                          <option value="{{$value->id}}"> {{$value->numero_documento." ".$value->nombre." ".$value->paterno." ".$value->materno}}</option>
                          @endforeach
                          @endif
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <div class="col-md-12">
                        <input type="date" value="" class="form-control" name="fecha_inicio" placeholder="">
                      </div>
                  ...
                  <!-- begin col-2 -->                                
                  <div class="form-group col-md-3">
                      <label class="col-md-12">A:</label>
                      <div class="col-md-12">
                        <input type="date" value="" class="form-control" name="fecha_fin" placeholder="">
                      </div>
