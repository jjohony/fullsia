        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/carrera/{{$carrera->id}}/curso/{{$curso->id}}" method="post" accept-charset="utf-8" id="formulario">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-9">
                        <select name="id_asignatura_mencion_pensum"id="select-id_asignatura_mencion_pensum" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="asignatura_mencion_pensum">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-9">
                        <select name="id_docente"id="select-id_docente" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="docente">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <label class="col-md-3 text-right">Foma de Evaluacion:</label>
                    <div class="col-md-9">
                        <select name="id_evaluacion"id="select-id_evaluacion" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="Evaluacion" required>
                            ...
                            <option value="{{$value->id}}" <?php echo($value->id==$curso->id_evaluacion)?'selected':'';?>>{{$value->evaluacion }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="paralelo_curso" class="form-control " id="input-paralelo_curso"   type="text" required value="{{$curso->paralelo_curso}}">    
                    </div>
              ...
              <!-- begin col-2 -->                                
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="turno_curso"id="select-turno_curso" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" >
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="cupo_curso" class="form-control " id="input-cupo_curso"   type="number"  value="50">    
                    </div>
                </div>
                <!-- begin col-2 -->                                
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="estado_curso"id="select-estado_curso" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" >
