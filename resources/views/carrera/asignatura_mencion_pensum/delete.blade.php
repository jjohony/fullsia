            ...
            <form action="{{url('')}}/carrera/{{$carrera->id}}/plan_estudio/{{$asignatura_mencion_pensum->id}}" method="post" accept-charset="utf-8" id="formulario">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-2 form-group" style="">
                        <input type="submit" value="Eiminar" name="guardar" class="btn btn-success">
                        <a href="{{url('')}}/carrera/$id_carrera/plan_estudio" class="btn btn-success">Cancelar</a>
                        <a href="{{url('')}}/carrera/$id_carrera/plan_estudio" class="btn btn-success">Volver a la Lista</a>
                    </div>
                </div>
