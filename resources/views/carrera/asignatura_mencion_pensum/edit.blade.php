...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/carrera/{{$carrera->id}}/plan_estudio/{{$asignatura_mencion_pensum->id}}" method="post" accept-charset="utf-8" id="formulario">
                {{csrf_field()}}
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_pensum"id="select-id_pensum" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="pensum">
                            <option value=""></option>
                            <?php 
                            if(!empty($pensum)){
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_mencion"id="select-id_mencion" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="mencion">
                            <option value=""></option>
                            <?php
                            if(!empty($mencion)){
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_asignatura"id="select-id_asignatura" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="asignatura">
                            <option value=""></option>
                            <?php 
                            if(!empty($asignatura)){
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="nivel_asignatura" class="form-control " id="input-nivel_asignatura"   type="number"  value="{{$asignatura_mencion_pensum->nivel_asignatura}}">    
                    </div>
                </div>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="modalidad_asignatura"id="select-modalidad_asignatura" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" >
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="horas" class="form-control " id="input-horas"   type="number"  value="{{$asignatura_mencion_pensum->horas}}">    
                    </div>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="label_prerequisito" class="form-control " id="input-label_prerequisito"   type="text"  value="{{$asignatura_mencion_pensum->label_prerequisito}}">    
                    </div>
                </div>    
            </form>
