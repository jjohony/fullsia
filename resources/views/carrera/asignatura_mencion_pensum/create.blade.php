        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/carrera/{{$carrera->id}}/plan_estudio" method="post" accept-charset="utf-8" id="formulario">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_pensum"id="select-id_pensum" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="pensum">
                            ...
                            <option value="{{$value->id}}">{{$value->pensum}}</option>
                            <?php
                            }}
                            ?>
                        </select>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_mencion"id="select-id_mencion" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="mencion">
                            ...
                            <option value="{{$value->id}}">{{$value->mencion}}</option>
                            <?php
                            }}
                            ?>
                        </select>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_asignatura"id="select-id_asignatura" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="asignatura">
                            ...
                            <option value="{{$value->id}}">{{$value->sigla_asignatura." ".$value->asignatura}}</option>
                            <?php
                            }}
                            ?>
                        </select>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="nivel_asignatura" class="form-control " id="input-nivel_asignatura"   type="number"  value="">    
                    </div>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="horas" class="form-control " id="input-horas"   type="number"  value="">    
                    </div>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="label_prerequisito" class="form-control " id="input-label_prerequisito"   type="text"  value="">    
                    </div>
                </div>    
            </form>
