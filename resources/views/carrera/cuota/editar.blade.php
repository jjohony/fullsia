        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/carrera/{{$carrera->id}}/estudiante/{{$estudiante->id}}/cuota/{{$cuota->id}}" method="post" accept-charset="utf-8" id="formulario">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="anio" class="form-control " id="input-anio"   type="number" required value="{{$cuota->anio}}">    
                    </div>
                </div>
                <!-- begin col-2 -->                                
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="monto" class="form-control " id="input-monto"   type="number" required value="{{$cuota->monto}}" step="0.01">    
                    </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-3">
                        <input name="fecha_registro" class="form-control " id="input-fecha_registro"   type="date" required value="{{$cuota->fecha_registro}}">    
                    </div>
