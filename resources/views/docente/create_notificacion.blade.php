...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/docente/notificacion" method="post" accept-charset="utf-8" id="formulario">
                {{csrf_field()}}
                  <h3 class="text-center">Formulario de envio de notificacion a Docentes</h3>
                  <!-- begin col-2 -->                                
                  ...
                  <div class="form-group col-md-offset-2 col-md-8">
                      ...
                      <div class="col-md-12">                        
                        <textarea name="notificacion_docente" class="form-control"></textarea>
                      </div>
                  ...
                  <div class="col-md-6 col-md-offset-3">                        
                    <input type="submit" value="Notificar" name="guardar" class="btn btn-success btn-block">
                  </div>                      
