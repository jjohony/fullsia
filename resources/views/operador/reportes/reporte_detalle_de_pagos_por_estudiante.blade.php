...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/reporte/reporte_detalle_de_pagos_por_estudiante" method="get" accept-charset="utf-8" id="formulario" target="_blank">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <div class="col-md-12">                        
                        <select class="form-control chosen-select" data-rel="chosen" data-placeholder="Todas" name="id_carrera">
