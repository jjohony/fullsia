...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <a href="{{url('')}}/reporte/reporte_personal_de_la_institucion"  class="btn btn-success" title="" target="_blank">Reporte Personal de la Institución</a>        
            <form action="{{url('')}}/reporte/reporte_planillas_sueldo_y_salarios" method="get" accept-charset="utf-8" id="formulario" target="_blank">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <label class="col-md-3 text-right">* Unidad / Area:</label>
                    <div class="col-md-6">
                        <select name="id_unidad_area"id="select-id_unidad_area" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="Unidad / Area">
                            <option value="">Todos</option>
                            <?php 
                            if(!empty($unidad_area)){
                            foreach ($unidad_area as $key => $value) {?>
                            <option value="{{$value->id}}">{{$value->unidad_area}}</option>
                            <?php
                            }}
                            ?>
                        </select>
