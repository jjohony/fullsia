...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/pago_docente" method="post" accept-charset="utf-8" id="formulario">
                {{csrf_field()}}
                
                <input type="hidden" value="{{$contrato->id}}" name="id_contrato_docente">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>AFPS 10%</td>
                          <td>{{$contrato->salario*0.1}}<input type="hidden" class="form-control" value="{{$contrato->salario*0.1}}" name="afp" disabed></td>
                        </tr>
                        <tr>
                          <td>HABER BASICO</td>
