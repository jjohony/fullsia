            ...
            <form >
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 form-group" style="">
                        ...
                        <a href="{{url('')}}/pago_docente/reporte_boleta_pago/{{$pago_docente->id}}" class="btn btn-success btn-block" target="_blank">Reporte</a>
                        <a href="{{url('')}}/pago_docente/reporte_detalle_boleta_pago/{{$pago_docente->id}}" class="btn btn-success btn-block" target="_blank">Reporte detallado</a>
                    </div>
                </div>
                
                <div class="col-md-4">
                  <?php 
                  if($pago_docente->foto_imagen=="")
                  {
                      $imagen=url('')."/assets/img/persona.png";    
                  }
                  else{
                      $imagen=url('')."/img/".$pago_docente->foto_imagen;    
                  }
                  ?>
