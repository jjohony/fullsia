...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/pago_docente/create" method="get" accept-charset="utf-8" id="formulario">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_contrato_docente"id="select-id_contrato_docente" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="Docente">
                            <option value=""></option>
                            <?php 
                            if(!empty($contratos)){
