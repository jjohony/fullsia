...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="" method="post" accept-charset="utf-8" id="formulario" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <select name="id_persona"id="select-id_persona" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" data-placeholder="{{$nombre_tabla}}" disabled>
                            <option value=""></option>
                            <?php 
                            if(!empty($$nombre_tabla)){
                            foreach ($$nombre_tabla as $key => $value) {?>
                            <option value="{{$value->id}}" <?php echo ($users->id_persona==$value->id)?'selected':''?>>{{$value->numero_documento." ".$value->paterno." ".$value->materno." ".$value->nombre}}</option>
                            <?php
                            }}
                            ?>
                        </select>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <input name="email"id="input-email" class="form-control" type="email" required value="{{$users->email}}" disabled>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="id_grupo"id="select-id_grupo" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" required disabled>
                            
                            <option value="1" <?php echo ($users->nombre_grupo=="administrador")?'selected':''?>>administrador</option>
                            <option value="2" <?php echo ($users->nombre_grupo=="operador")?'selected':''?>>operador</option>
                            <option value="5" <?php echo ($users->nombre_grupo=="academico")?'selected':''?>>academico</option>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="estado_users"id="select-estado_users" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" required disabled>
                            
                            <option value="activo" <?php echo ($users->estado_users=="activo")?'selected':''?>>activo</option>
                            <option value="eliminado" <?php echo ($users->estado_users=="eliminado")?'selected':''?>>eliminado</option>
