...
<div class="row">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            <form action="{{url('')}}/usuario/{{$nombre_tabla}}/{{$users->id}}" method="post" accept-charset="utf-8" id="formulario" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-6">
                        <input name="email"id="input-email" class="form-control" type="email" required value="{{$users->email}}">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <label class="col-md-3 text-right">Clave:</label>
                    <div class="col-md-3">
                        <input name="password"id="select-password" class="form-control " >

                    </div>
                    <div class="col-md-3">
                        <span>Para modificar la clave de usuario.</span>
                    </div>
                </div>
                <!-- end col-2 -->                      
                <div class="form-group col-md-12 ">
                    ...
                    <div class="col-md-3">
                        <select name="estado_users"id="select-estado_users" class="form-control chosen-select" data-rel="chosen" data-parsley-group="" required>
